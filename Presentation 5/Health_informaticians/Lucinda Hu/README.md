...
3. It significantly improved the epithelium coverage, decrease background, and improved score for almost all matches, the code just didn't work once for melan case101 match#1 due to incompatibility with the image's index too large, which I choose going back to the original method. All other matches were able to be compatible with the new method.
