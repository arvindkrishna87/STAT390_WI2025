...
## Code updates (2)
- First, I changed the format of the code so as to loop through every file in the `input` folder, rather than having to manually run for each individual slide. (This loop can be seen starting Line 46).
- Adjusted `extension_factor` to 1.2 for large enough tissues (Lines 114-122)
...
- Skipped tiny patches (Lines 124-127)
